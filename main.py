...
#print the head of the data post-encoding
print(dfFinal.head())
...
# SVM, guessing if person makes above 50k or not
SVM(dfFinal)

#neural network classifier, guessing if person makes above 50k or not
nnc(dfFinal)